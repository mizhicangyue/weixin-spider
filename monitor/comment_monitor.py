...
from api import get_history_api, get_html_api, get_article_comments_api
...
class CommentMonitor:
    ...
    def start(self):
        while 1:
            ...
            article_list = models.Article.query.filter_by(
                ...
                models.Article.comment_update < time.time() - WX_UPDATE_TIME,
    ...
    def _run(self, article_id):
        ...
        while 1:
            try:
                print(comment_id, self.key_dict[biz][1], self.key_dict[biz][0])
